...
<head>
    ...
    <style>
        ...
        .add-participant, .back-dashboard {
            display: flex;
            align-items: center;
            padding: 10px 15px;
            border-radius: 5px;
...
<body>
    ...
    <h2 style="text-align: center;">List of Participants</h2>
        ...
        <div class="button-container">
            <a href="/participants/create" class="add-participant">
                <i class="material-icons">add</i> Add New Participant
            </a>
        </div>
            ...
            <table class="styled-table">
                ...
                <tbody>
                    <?php foreach ($participants as $participant): ?>
                        <tr>
                            <td><?= esc($participant['id']) ?></td>
                            <td><?= esc($participant['user_name']) ?></td>
                            <td><?= esc($participant['event_title']) ?></td>
                            <td class="action-buttons">
                                <a href="/participants/edit/<?= esc($participant['id']) ?>" class="edit-button">Edit</a>
                                <a href="/participants/delete/<?= esc($participant['id']) ?>" class="delete-button" onclick="return confirm('Are you sure you want to delete this participant?')">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
